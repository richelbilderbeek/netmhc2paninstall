...
#' Use \link[netmhc2pan]{get_netmhc2pan_archive_filename}
...
#' Use \link[netmhc2pan]{get_netmhc2pan_bin_url} to get the default URL.
...
#'   Use \link[netmhc2pan]{get_netmhc2pan_data_url} to get the default URL.
...
#'   Use \link[netmhc2pan]{get_default_netmhc2pan_folder} to see the location
#'   of the default NetMHCIIpan folder.
#'   Use \link[netmhc2pan]{get_default_netmhc2pan_subfolder} to see the location
...
#'   Use \link[netmhc2pan]{get_default_netmhc2pan_version} to get the default
#'   NetMHCIIpan version
